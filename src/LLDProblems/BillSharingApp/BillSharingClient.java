...
public class BillSharingClient {
  ...
  */
  public static void main(String[] args) {
    ...
    BillSharingManagerService billSharingManagerService =
        new BillSharingManagerService(
    ...
    splitDetailsDto.setSplitUserList(
        Arrays.asList(user2.getName(), user3.getName(), user4.getName()));
    try {
