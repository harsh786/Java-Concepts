package JavaConcepts.MulithreadingConcepts;
...
// if there are multiple threads and they are working on some common same object then in this
// scenerio syncronized are used
class Singleton {
...
public class MulThreadingConcepts {
    ...
    public static void main(String[] args) {
        ...
        /*
         * ObjThread1.start(); try { ObjThread1.join();//now t2 run after t1 died } catch
